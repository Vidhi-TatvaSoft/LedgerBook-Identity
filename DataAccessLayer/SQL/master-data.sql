IF NOT EXISTS (SELECT TOP 1 1 FROM Users WHERE Email = 'super@admin.com' AND DeletedAt IS NULL)
BEGIN
	INSERT INTO Users (FirstName, LastName, Email, [Password], CreatedAt, IsUserRegistered)
	VALUES
	('Super', 'Admin', 'super@admin.com', 'VnZ2QDEyMw==', GETUTCDATE(), 1)
END
